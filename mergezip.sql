...
CREATE OR REPLACE PROCEDURE CSE532.MERGE_ZIPCODE (OUT STDDEV NUMERIC(15,5))
	...
	P1: BEGIN
		...
		-- DECLARE GLOBAL TEMPORARY TABLE  SESSION.zip_code_details (
	 --    	zip_code INT,
	 --    	population BIGINT,
	 ...
	 --    );
		...
		-- CALL DB2GSE.ST_REGISTER_SPATIAL_COLUMN('SESSION','zip_code_details','shape', 'NAD83_SRS_1');
		-- call ST_REGISTER_SPATIAL_COLUMN(NULL,'zip_code_details','shape', 'NAD83_SRS_1');
		...
		SELECT COUNT(*) INTO curr_avg_population
